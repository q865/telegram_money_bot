    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            bot.on('text', function (ctx) { return __awaiter(_this, void 0, void 0, function () {
                var idName, sendlerName, msg, r, r2, counter, list, answer;
                return __generator(this, function (_a) {
                    idName = ctx.message.from.username;
                    sendlerName = ctx.message.from.first_name;
                    msg = ctx.message.text;
                    if (msg === 'двухстволка')
                        ctx.replyWithPhoto("".concat(db.guns[getRandomInt(db.guns.length)]));
                    if (msg === 'дрочка')
                        ctx.replyWithHTML("<b>".concat(db.drochka[getRandomInt(db.drochka.length)], "</b>"));
